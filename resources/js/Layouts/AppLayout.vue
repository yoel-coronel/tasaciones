    ...
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <main>
                ...
                <div class="grid grid-flow-row-dense grid-cols-12 place-content-start md:place-content-center gap-x-1">

                    <div class="col-span-1 md:col-span-2 border-r-2 border-gray-200  hidden md:block">
                        <!--min-h-screen-->
                    ...
                    <div class="col-span-12 md:col-span-10">
                        ...
                        <header class="bg-white shadow border-b-1" v-if="$slots.header">
                            <div class="mx-auto py-6 px-2 sm:px-6 lg:px-8">
